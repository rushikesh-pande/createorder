package com.orderprocessing.createorder.monitoring.aspect;
...
public class MonitoringAspect {
    ...
    public Object monitorControllerMethod(ProceedingJoinPoint pjp) throws Throwable {
        ...
        String metricName = "createorder.controller.duration";
        ...
        try {
            ...
            Counter.builder("createorder.controller.errors")
    ...
    public Object monitorServiceMethod(ProceedingJoinPoint pjp) throws Throwable {
        ...
        try {
            ...
            meterRegistry.timer("createorder.service.duration",
                    "service", "createorder",
                    "class",  className,
                    "method", methodName)
